...
emotion.SmileyBox = {tab0:[],tab1:[],tab2:[],tab3:[],tab4:[]};
emotion.SmileyInfor = {tab0:[],tab1:[],tab2:[],tab3:[],tab4:[]};
...
if (editor.options.emotionLocalization) {
    ...
    initImgBox(faceBox['tab4'], 'f_00', 50);
} else {
    initImgBox(faceBox['tab0'], 'j_00', 84);
    initImgBox(faceBox['tab1'], 't_00', 40);
    initImgBox(faceBox['tab2'], 'w_00', 52);
    initImgBox(faceBox['tab3'], 'B_00', 63);
    initImgBox(faceBox['tab4'], 'i_f', 50);
}
...
inforBox['tab4'] = ['微笑','亲吻','调皮','惊讶','耍酷','发火','害羞','汗水','大哭','得意','鄙视','困','夸奖','晕倒','疑问','媒婆','狂吐','青蛙','发愁','亲吻','','爱心','心碎','玫瑰','礼物','哭','奸笑','可爱','得意','呲牙','暴汗','楚楚可怜','困','哭','生气','惊讶','口水','彩虹','夜空','太阳','钱钱','灯泡','咖啡','蛋糕','音乐','爱','胜利','赞','鄙视','OK'];


//大对象
FaceHandler = {
    imageFolders:{    tab0:'jx2/',tab1:'tsj/',tab2:'ldw/',tab3:'bobo/',tab4:'face/'},
    imageWidth:{tab0:35,tab1:35,tab2:35,tab3:35,tab4:35},
    imageCols:{tab0:11,tab1:11,tab2:11,tab3:11,tab4:11},
    imageColWidth:{tab0:3,tab1:3,tab2:3,tab3:3,tab4:3},
    imageCss:{tab0:'jd',tab1:'tsj',tab2:'ldw',tab3:'bb',tab4:'pp'},
    imageCssOffset:{tab0:35,tab1:35,tab2:35,tab3:35,tab4:25},
    tabExist:[0,0,0,0,0]
};
